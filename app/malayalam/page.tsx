    ...
    <main id="main">
      ...
      <section className="ml-faq-section ml-container"><div><span className="ml-eyebrow">A FEW THINGS YOU MAY WONDER</span><h2>Made for children. <br />Thought through <br />for parents.</h2></div><div className="ml-faq-list">
        {[
          ...
          ['What can we try today?', 'The dashboard now includes a first reading lesson with spoken guidance, meaning pictures, letter choices and word building, plus three short word previews. Formation videos and tracing are still being prepared. The full programme is in development; guided practice does not establish independent reading.'],
