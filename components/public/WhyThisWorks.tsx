...
const benefits = [
  ...
  },
  {
    ...
    description: "Nobody can join Level 2, 3, or 4 directly. Without the correct foundation, children cannot move on. Every child builds the right base first.",
  },
  {
    icon: "💰",
    title: "Try Before You Commit",
    description: "Try 4 lessons free. No registration. Then enroll level-by-level. Complete Level 1, then decide if you want Level 2. No subscriptions.",
  },
  {
    icon: "🛡️",
    title: "Child Wellbeing First",
    description: "One lesson per day. No ads, no distractions. Your child learns at their own pace — then done. Healthy habits, real progress.",
  },
];
      ...
      <div className="container mx-auto max-w-5xl">
        <div className="text-center mb-10">
          ...
          <p className="text-lg text-apty-gray max-w-2xl mx-auto">
            We help children become confident readers — not keep them inside an app.
          </p>
        </div>
