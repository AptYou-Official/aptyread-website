  ...
  return (
    <div className="space-y-2">
      {items.map((faq, index) => (
        <div
          key={faq.question}
          className="border border-apty-cyan/15 rounded-xl overflow-hidden bg-white"
        >
          <button
            type="button"
          ...
          >
            ...
            <span
              className={`flex-shrink-0 w-8 h-8 rounded-full bg-apty-cyan/10 text-apty-cyan flex items-center justify-center text-xl transition-transform ${
